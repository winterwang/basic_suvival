...
- The basic principle: let's consider two variables $x_1, x_2$, where $x_1$ is of interest, and $x_2$ is potential confounder: 
    ...
    - Fit the survival model (Cox/exponetial/Weibull) **with and without** inclusion of $x_2$; 
...
If not, infereces could be invalid and incorrect conclusions could be drawn on the research question of interest. 
...
---
class: middle
### **Assessing the correct functional form of continuous variables**
...
h(t|x) & = h_0\exp(\beta_1 x + \beta_2 x^2) 
\end{aligned}
$$
